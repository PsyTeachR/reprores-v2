...
Load the dataset [personality](https://psyteachr.github.io/psyteachr/data/personality.csv).
...
Load the dataset [family_composition](https://psyteachr.github.io/psyteachr/data/family_composition.csv) from last week's exercise.
...
Use the dataset [eye_descriptions](https://psyteachr.github.io/msc-data-skills/data/eye_descriptions.csv) from last week's exercise.
