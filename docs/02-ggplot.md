...
Download the [exercises](exercises/02_ggplot_exercise.Rmd). See the [plots](exercises/02_ggplot_answers.html) to see what your plots should look like (this doesn't contain the answer code). See the [answers](exercises/02_ggplot_answers.Rmd) only after you've attempted all the questions.
...
reprores::exercise(2, answers = TRUE)
```
