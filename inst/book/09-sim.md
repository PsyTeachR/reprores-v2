...
<img src="09-sim_files/figure-html/faux-sim-design-1.png" width="100%" style="display: block; margin: auto;" />
...
Download the [exercises](exercises/09_sim_exercise.Rmd). See the [answers](exercises/09_sim_answers.Rmd) only after you've attempted all the questions.
...
reprores::exercise(9, answers = TRUE)
```
