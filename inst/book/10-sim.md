...
<img src="10-sim_files/figure-html/rnorm-1.png" width="100%" style="display: block; margin: auto;" />
...
Let's say we want to model how many texts you get each day for a whole. You know that you get an average of 20 texts per day. So we set `n = 365` and `lambda = 20`. Lambda is a <a class='glossary' target='_blank' title='A quantity characterizing a population.' href='https://psyteachr.github.io/glossary/p#parameter'>parameter</a> that describes the Poisson distribution, just like mean and standard deviation are parameters that describe the normal distribution.
...
<img src="10-sim_files/figure-html/faux-sim-design-1.png" width="100%" style="display: block; margin: auto;" />
...
<img src="10-sim_files/figure-html/plot-reps-binom-1.png" width="100%" style="display: block; margin: auto;" />
...
<img src="10-sim_files/figure-html/plot-height-means-1.png" width="100%" style="display: block; margin: auto;" />
...
<img src="10-sim_files/figure-html/sim-height-20-1.png" width="100%" style="display: block; margin: auto;" />
...
<tbody>
  ...
  <tr>
   ...
   <td style="text-align:left;"> Parameters showing how a set of vectors vary and are correlated. </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td style="text-align:left;"> The difference between the effect in your data and the null effect (usually a chance value) </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td style="text-align:left;"> A false positive; When a test concludes there is an effect when there is really is no effect </td>
  </tr>
  <tr>
   ...
   <td style="text-align:left;"> A false negative; When a test concludes there is no effect when there is really is an effect </td>
  </tr>
  <tr>
