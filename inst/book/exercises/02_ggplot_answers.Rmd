---
title: 'Formative Exercise 02: Data Visualisation'
output: 
  html_document:
    df_print: kable
---
...
```{r exercise-grid, fig.width = 8, fig.height = 4, out.width = "100%"}
dog_violin + dog_boxplot + dog_column +
...
```{r exercise-lineplot}
data("disgust_scores", package = "reprores")
...
disgust_density <- ggplot(disgust_scores, aes(moral, pathogen)) +
...
```{r exercise-heatmap}
data("disgust_cors", package = "reprores")
