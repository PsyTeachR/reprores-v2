...
```
##  [1]  1.5550966  1.5179173 -0.1616742 -0.2771432 -1.3731141 -0.7005269
##  [7]  0.6551553  0.9600303 -0.2808920 -1.2127889
```
...
```
##  [1] 101.88358  99.82420 100.62578  99.83426 101.19967  99.00016 100.08485
##  [8]  99.22826 100.67732 100.10500
```
...
```
##  [1] 100.51506  99.04419 100.81551 101.51703  99.15236  99.65779  98.23112
##  [8]  99.74207  99.90116 100.13952
```
...
```
##  [1]  -69.40568   80.18255  -90.62502   46.03072 -132.72029  -57.43528
##  [7]  -67.70168  -33.70195   65.60583  120.07629
```
...
* What is the default value for `sd`? <select class='webex-select'><option value='blank'></option><option value=''>0.05</option><option value=''>NULL</option><option value='answer'>1</option><option value=''>two.sample</option></select>
...
* Which is equivalent to <code><span class='fu'><a href='https://rdrr.io/r/stats/power.t.test.html'>power.t.test</a></span><span class='op'>(</span><span class='fl'>100</span>, <span class='fl'>0.5</span><span class='op'>)</span></code>? <div class='webex-radiogroup' id='radio_ORMXUJJVDH'><label><input type="radio" autocomplete="off" name="radio_ORMXUJJVDH" value=""></input> <span>power.t.test(100, 0.5, sig.level = 1, sd = 0.05)</span></label><label><input type="radio" autocomplete="off" name="radio_ORMXUJJVDH" value=""></input> <span>power.t.test(n = 100)</span></label><label><input type="radio" autocomplete="off" name="radio_ORMXUJJVDH" value=""></input> <span>power.t.test()</span></label><label><input type="radio" autocomplete="off" name="radio_ORMXUJJVDH" value="answer"></input> <span>power.t.test(delta = 0.5, n = 100)</span></label></div>
